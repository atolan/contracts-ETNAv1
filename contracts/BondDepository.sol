...
/* ======== CONSTRUCTOR ======== */
  ...
  // Gets bond information
  function bondInfo(uint256 _bid) public view returns (Bond memory, Terms memory) {    
    return (bonds[_bid], terms[_bid]);
  }
  ...
  function deposit(
    ...
    bond.quoteToken.transferFrom(msg.sender, transferTo, _amount);

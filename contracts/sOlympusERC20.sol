...
contract sOlympus is IsOHM, ERC20Permit {
    ...
    constructor() ERC20("Staked ETNA", "sETNA", 9) ERC20Permit("Staked ETNA") {
    ...
    function debtBalanceOf(address debtor) external view override returns (uint256) {
        return debtBalances[debtor];
    }
